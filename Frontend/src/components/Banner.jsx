    ...
    <>
        <div className='max-w-screen-2xl container mx-auto md:px-20 px-4 flex flex-col md:flex-row my-10'>
          <div className='w-full  order-2 md:order-1 md:w-1/2 mt-12 md:mt-32'>
            ...
            <p className='text-xl'>
            Dive into our curated collection of books spanning every genre imaginable. Whether you’re a fan of fiction, non-fiction our website is your go-to destination .
            </p>
